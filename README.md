...
✨ Features
Real-time Analysis: Get instant results using the VADER sentiment lexicon.

Modern UI: A clean, glassmorphism-inspired interface with CSS animations.

NLP Pipeline: Implements Tokenization and Lemmatization to process text efficiently.
